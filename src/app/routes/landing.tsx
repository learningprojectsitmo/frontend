...
const LandingRoute = () => {
  ...
  return (
    <>
      <Head description="Платформа для управления учебными проектами" title="Learning Projects" />
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-primary/5 to-background">
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <span className="block text-primary">Платформа для <span className="underline decoration-primary/50">учебных проектов</span></span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" onClick={handleStart} className="transform transition-transform hover:scale-105">
              Начать работу
            </Button>
      ...
      <div className="py-16 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground">Возможности платформы</h2>
      ...
      <div className="bg-primary/5 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold tracking-tight text-foreground">Готовы начать?</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Присоединяйтесь к <span className="font-semibold text-foreground">1,000+ студентов и преподавателей</span>, уже использующих платформу
          </p>
          <div className="mt-8">
            <Button size="lg" onClick={handleStart} className="transform transition-transform hover:scale-105">
      ...
      <footer className="border-t py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-sm text-muted-foreground flex flex-col sm:flex-row justify-center items-center gap-4">
          <span>&copy; {new Date().getFullYear()} Learning Projects. Все права защищены.</span>
          <div className="flex gap-4">
            <a href="#" className="hover:text-primary transition-colors">Политика конфиденциальности</a>
            <a href="#" className="hover:text-primary transition-colors">Связаться с нами</a>
          </div>
        </div>
      </footer>
    </>
