...
export type SuggestionListProps = SuggestionProps<SlashCommandSuggestionItem, unknown>;
...
const SuggestionList = forwardRef<SuggestionListHandle, SuggestionListProps>((props, ref) => {
    ...
    if (prevResetKey.count !== filteredItems.length || prevResetKey.query !== searchQuery) {
        setPrevResetKey({
            count: filteredItems.length,
            query: searchQuery,
        });
