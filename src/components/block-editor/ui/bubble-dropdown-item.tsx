...
const BubbleDropdownItem = React.forwardRef<HTMLButtonElement, BubbleDropdownItemProps>(
    ({ className = "", active = false, danger = false, ...props }, ref) => {
        ...
        return <button ref={ref} type="button" data-dropdown-item className={cls} {...props} />;
    },
);
