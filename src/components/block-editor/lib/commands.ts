...
export interface BlockEditorChainedCommands {
    deleteRange: (range: { from: number; to: number }) => BlockEditorChainedCommands;
    ...
    toggleCodeBlock: (attributes?: { language?: string }) => BlockEditorChainedCommands;
    toggleHeading: (attributes: { level: 1 | 2 | 3 | 4 | 5 | 6 }) => BlockEditorChainedCommands;
