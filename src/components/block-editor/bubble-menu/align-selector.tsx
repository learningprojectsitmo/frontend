...
const alignItems = [
    {
        command: (e: Editor) =>
            (e.chain().focus() as unknown as AlignableChain).setTextAlign("left").run(),
    ...
    {
        command: (e: Editor) =>
            (e.chain().focus() as unknown as AlignableChain).setTextAlign("center").run(),
    ...
    {
        command: (e: Editor) =>
            (e.chain().focus() as unknown as AlignableChain).setTextAlign("right").run(),
...
export const TextAlignSelector = ({ editor }: { editor: Editor }) => {
    ...
    const editorState = useEditorState(
        ...
        (ed) => ({
            ...
            isAlignLeft:
                !ed.isActive({ textAlign: "center" }) && !ed.isActive({ textAlign: "right" }),
