          ...
          <div className="mt-8">
            ...
            <nav className="space-y-1">
              {disciplines.map((item) => (
                <button key={item.name} className="w-full flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 bg-red-500 text-[10px] text-white w-4 h-4 flex items-center justify-center rounded-full border-2 border-white">3</span>
            </div>
