            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                        <h3 className="text-base font-semibold text-[#222] truncate leading-snug">
                            {title}
                        </h3>

                        <button
                            className="shrink-0 text-[#8A8A8A] hover:text-gray-600 transition-colors opacity-0 group-hover:opacity-100"
                            title="Редактировать"
                        >
                    ...
                    <p className="text-[15px] font-bold text-[#222] mt-1.5">{role}</p>
                    ...
                    {visibleItems.length > 0 && (
                        <ul className="mt-2.5 space-y-1">
                            {visibleItems.map((item, i) => (
                                <li
                                    key={i}
                                    className="text-sm text-[#333] leading-relaxed flex items-start gap-1.5"
                                >
