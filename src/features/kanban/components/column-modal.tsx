                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    selectedColor === 'white' && 'ring-2 ring-blue-500 ring-offset-1'
                                )}
                                title="Белый"
                        ...
                        <div className="grid grid-cols-7 gap-5">
                            {Object.entries(columnColors).map(([colorName, styles]) => (
                                <button
                                    key={colorName}
                                    type="button"
                                    onClick={() => setValue('color', colorName as ColumnFormData['color'])}
                                    className={cn(
                                        'w-full aspect-square rounded-full transition-all',
                                        'hover:scale-110 hover:shadow-md',
                                        styles.header,
                                        selectedColor === colorName && 'ring-2 ring-blue-500 ring-offset-1'
                                    )}
