...
export function Sidebar({
    ...
    return (
        ...
        >
            ...
            {isLoading ? (
                // 1. Загрузка
                isCollapsed ? <SidebarSkeletonCollapsed /> : <SidebarSkeleton />
            ) : isNotFound ? (
                // 2. 404 — ресурс не найден
                isCollapsed ? <SidebarNotFoundCollapsed /> : <SidebarNotFound />
                    ...
                    {isCollapsed ? (
                        ...
                        <div className="p-2 flex flex-col gap-1 items-center">
                            ...
                            {activeCategories.map((category) => (
                                <div key={category.name} className="flex flex-col gap-2 items-center w-full">
