...
export function FilterDropdown({ open, onClose, onReset, children }: FilterDropdownProps) {
    ...
    return (
        <>
            <div
                ref={ref}
                className="absolute top-full mt-2 right-0 z-[110] w-[320px] bg-app-surface border border-gray-200 rounded-[18px] shadow-[0_10px_15px_rgba(0,0,0,0.05),0_25px_50px_rgba(0,0,0,0.12)] p-2 animate-filter-in"
            >
